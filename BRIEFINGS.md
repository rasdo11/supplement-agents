...
### Sourcing — Pricing Research

**Most Important Finding:** Your 150-unit pre-order target is dangerously below industry MOQ floors. The standard MOQ for custom capsule formulas is 2,500–5,000 units — meaning Ross needs a plan to bridge the gap between 150 pre-orders and the minimum batch size, or must identify the small handful of manufacturers who go lower.

- **Per-Unit Cost (Capsules, US Manufacturers):** Capsules/tablets run $0.20–$1.50/unit for material and labor, excluding packaging and design. Small batch runs might cost around $2–$5 per unit, whereas larger orders can reduce this to $1–$2 per unit.
- **MOQ Reality Check — Standard Market:** Most custom manufacturers set an MOQ of 2,500–5,000 units/SKU for capsules, tablets, or powder pouches. Some specialized manufacturers offer as low as 100–2,500 units to test new products, though unit costs are often higher.
- **MOQ Reality Check — Low-MOQ Options:** Nutracap (GA-based) offers custom formulation with orders of 500+ units — the lowest confirmed floor among capsule-focused US manufacturers. Matsun Nutrition advertises an MOQ of 2,500 units. NutraScience Labs is best suited for high-volume (millions of capsules).
- **Setup & R&D Fees (Hidden First-Run Costs):** Custom formulas carry R&D fees of $2,000–$10,000+ per SKU. Testing adds $300–$2,000 per batch; label printing $0.03–$0.15/unit; bottles $0.20–$1.00/unit.
- **Total First-Run Budget Benchmark:** Expect $20,000–$40,000 for a startup MOQ order (2,500–5,000 units) with basic custom formulation, setup, packaging, and compliance costs.

**⚠️ MOQ Math:** 150 pre-orders ≠ a production run. Even the lowest-MOQ US manufacturers (Nutracap at 500 units) require you to produce 3–4x your pre-order count.

**Recommended Action:** Request a formal quote from Nutracap (nutracapusa.com) for a 500-unit custom capsule run of creatine monohydrate + magnesium glycinate. Use this quote as your baseline to pressure-test Makers Nutrition and Vitalpax.

---

### Science — Magnesium Forms Deep Dive

**Lead Finding:** The evidence has bifurcated — Glycinate wins for sleep/anxiety; Threonate wins for cognition.

- **Magnesium Glycinate (Bisglycinate):** A 2025 RCT in *Nutrients* (155 adults, poor sleep) showed 28% improvement on the Insomnia Severity Index vs. 18% for placebo (p=0.049). A 2024 systematic review in *Cureus* concluded magnesium is "likely useful in the treatment of mild anxiety and insomnia." ⚠️ Limited evidence specifically on glycinate for anxiety/depression — commonly used but more robust studies needed.
- **Magnesium L-Threonate (Magtein®):** Only form clinically shown to cross the blood-brain barrier. 2024 RCT (*Sleep Medicine X*): significantly outperformed placebo for deep sleep, REM sleep, and readiness scores. 2025 RCT (*Frontiers in Nutrition*, 100 adults 18–45): improves memory and reduces "brain age" by 7.5 years at 2g/day.
- **Magnesium Citrate:** High bioavailability but natural osmotic laxative effect — not appropriate for a capsule product targeting sleep and wellness.
- **Perimenopause relevance:** Glycinate best addresses the most common complaints (insomnia, anxiety, muscle tension). If brain fog is primary, threonate is stronger.
- **Dosing ceiling:** NIH tolerable upper intake for supplemental magnesium is 350mg/day.

**Formula Recommendation:** Stick with magnesium glycinate (200–300mg elemental) as primary form. Seriously evaluate a "dual-form" upgrade: add Magtein® L-threonate (500–1,000mg compound = ~38–75mg elemental) alongside glycinate to legitimately claim both sleep *and* cognitive/mood support. The 2025 Frontiers in Nutrition RCT enrolled adults 18–45, directly applicable to your customer profile.

---

## Wednesday, 2026-03-25

### Sourcing — Raw Material Costs

**Top Finding:** Creatine monohydrate is at a historic pricing low right now — a strategic buying window that directly reduces your COGS and improves margin on your batch-drop model.

- **Creatine monohydrate (China-origin):** ~$2.80–$3.30/kg USD. Prices ~50% lower than early 2025. 30% YoY decline from 2024. Prices could rebound in 2026 as global demand recovers. **Lock in now.**
- **Creapure® (Germany):** 3–5x price premium over Chinese-origin but a powerful label story for your women's wellness audience. Used by Momentous and BPN.
- **US-based option:** Vivion offers wholesale creatine monohydrate starting from 25 kg, FDA-registered with COA documentation.
- **Magnesium glycinate (China-origin):** Functional-grade ~$8–$15/kg realistically for small brands. MOQs generally 25–50 kg.
- **Nutri Avenue (FDA-registered, US warehouses):** Stocks both creatine and magnesium glycinate — one-stop sourcing option worth a quote request.
- **⚠️ Purity watch:** Some magnesium glycinate products contain a mixture of magnesium glycinate and magnesium oxide. Demand a COA from any supplier.
- **Rough COGS estimate:** ~$0.01–0.02/serving creatine + ~$0.02–0.04/serving mag glycinate = **~$0.03–0.06/serving** combined raw ingredient cost.

**Recommended Action:** Request a formal quote + COA from Nutri Avenue (nutriavenue.com) for both creatine monohydrate and magnesium glycinate at 25 kg each. Simultaneously, ask your three contract manufacturers whether they source ingredients in-house or pass-through raw material costs.

---

### Science — Dosing Optimization

**Lead Finding:** 3g/day is likely the floor for muscle saturation, but probably insufficient for cognitive effects in healthy young adults. The dose-benefit relationship for cognition is bifurcated: high (≥5g) for brain, low (3g) for muscle maintenance.

- **What does 3g actually do?** ~1–3g/day replaces normal daily losses. Supplementation can augment intramuscular creatine saturation by ~20%. At 1.5–3g/day, the formula supports this incremental gain — but don't overclaim.
- **Cognitive claims at low doses — thin ice:** The only RCT at ~2.2g/day found no significant differences between creatine and placebo in any cognitive endpoint. EFSA (2024) reviewed a formal health claim for "creatine → cognitive function" at 3g/day and found no effect.
- **Higher doses for brain:** Dosages of 20g+ have shown the most consistent results for increasing brain creatine levels. Only ~5% of total body creatine is stored in the brain.
- **Where cognitive science does support a signal:** A 2024 meta-analysis (16 RCTs) found significant positive effects on memory, attention time, and processing speed. Creatine was **more beneficial in females and those aged 18–60 years.** Effects most pronounced under conditions of metabolic stress or fatigue.
- **⚠️ Flag:** The brain-benefit literature is dominated by 5–20g doses, not 1.5–3g. Muscle energy support is the scientifically defensible claim at your range.

**Formula Recommendation:** Land on 3g creatine monohydrate — minimum credible dose with saturation evidence. Pair with "supports cellular energy and muscle recovery" structure/function claim. At 3g creatine + 200mg magnesium glycinate, you can fit the full formula into **4 capsules** at ~800mg each.

---

## Thursday, 2026-03-26

### Sourcing — Competitor Analysis (DTC, Women-Focused)

**Most Important Finding:** The "creatine for women" category is exploding but critically underdeveloped in the capsule + magnesium glycinate combo format. Most competitors are powders. There is a clear white space at the premium capsule tier for a longevity-positioned, dual-ingredient product.

- **Demand accelerating:** "Creatine for Women" = 49,500 monthly searches, +123% YoY growth. "Magnesium Glycinate" = 823,000 monthly searches, +22% YoY.
- **Mindbodygreen** = closest competitor (powder, magnesium *malate*, not glycinate), $30–$99/month. No capsule format. Gap: they use malate, not glycinate.
- **Peach Perfect** = dominates women's Amazon/DTC, but fitness/glutes-first, NOT longevity. Powder, ~$34.97/30 servings.
- **Bloom Nutrition:** Powder, ~$29–$34, women/fitness, no magnesium.
- **Thorne combo:** Powder + capsule bundle, ~$60+, clinical positioning, uses CitraMalate.
- **Ross's target:** Capsule, ~$39–$49, women 30–45 longevity, glycinate — **no direct competitor owns this position.**
- **The capsule format is specifically going viral** on social media while the market remains powder-dominated.

**Recommended Action:** Draft a one-page positioning brief calling out the three differentiators no competitor owns simultaneously: **(1) capsule format, (2) magnesium glycinate specifically, (3) longevity/perimenopause messaging (not aesthetics/glutes).** Move fast before mindbodygreen or Bloom adds a glycinate capsule SKU.

> **Ross's note (Mar 26):** "How big are the capsules going to be? And how many per day if it's 3g of creatine vs 5"

---

### Science — Synergy & Third Ingredient Additions

**Lead Finding:** The creatine + magnesium mechanism is real, and Vitamin D3 is the strongest third-ingredient candidate.

**Three candidate additions — ranked:**

1. **Vitamin D3 — Strongest Case:** Fits within 4–6 cap budget (~1 small capsule). Magnesium and vitamin D deficiencies both associated with impaired muscular function. A 2024 review found vitamin D had significant effect lowering depressive symptoms. Already appearing in leading creatine-magnesium commercial combos (Livadur by Suppliva). Unlocks a defensible narrative: *energy + recovery + resilience.*
2. **Phosphatidylserine (PS) — Cognitively compelling but bulky:** "A really promising nootropic and cognitive-enhancing combo" for aging populations (Kristina Kendall, Ph.D.). However, effective dose is 100–300mg/day, adding 1–2 large capsules — likely blows your 4–6 cap limit.
3. **B Vitamins (B6/B12/Folate) — Plausible but not urgent:** Creatine synthesis consumes methyl groups. However, a study in women taking 3g/day creatine found no significant difference in homocysteine — the concern is theoretical for your healthy 30–45 female target.

**⚠️ Where science doesn't support the marketing:** The 1.5–3g range is below what emerging research suggests for brain benefits. Only ~5% of body creatine is stored in the brain.

**Formula Recommendation:** Add Vitamin D3 at 1,000–2,000 IU. Keep phosphatidylserine on the roadmap for a future premium cognitive SKU.
...
**Most Important Finding:** Your capsule formula is a lead-time advantage. Capsules are the fastest format to manufacture — expect 4–8 weeks for a private label run vs. 8–16 weeks for custom formulations. A two-ingredient mineral/amino acid formula is among the simplest to produce.

- **Standard first-run lead times:** 8–10 weeks for first-time productions, 6–8 weeks for repeat. Stock formulas: 2–4 weeks. Private label: 4–8 weeks. Custom: 8–16 weeks. Push toward private label/stock formula if possible.
- **Vitalpax (Utah)** actively markets speed: claims brands sell 57% faster, products and services average 37% less than competitors. Flexible for small and large batch orders.
- **#1 delay killer = custom packaging.** Use stock bottles. Finalize label artwork before manufacturing starts.
- **In-house testing cuts QC time nearly in half:** 2–4 weeks → 1–2 weeks if manufacturer does QC in-house. Ask all three manufacturers explicitly.
- **Rush fees:** Typically 10–20% extra. Raw material shortages can add 2–4 weeks; QC failures/batch rework add 1–3 weeks.

**Recommended Action:** Email all three manufacturers today with one specific question: *"Do you stock creatine monohydrate and magnesium glycinate on-hand, and what is the lead time for a private-label capsule run at your minimum order quantity?"* Vitalpax should be your first call given their explicit speed-to-market positioning.

---

### Science — FDA Claims & Regulatory

**Lead Finding:** FDA is in a "New Era" of proactive enforcement — actively monitoring all channels including social media, websites, and influencer content.

- **Structure/function claims — three hard requirements per FDA (21 CFR 101.93):** (1) Must have substantiation *before* making claims. (2) Must notify FDA within 30 days of first marketing. (3) Label must include the DSHEA disclaimer ("FDA has not evaluated...").
- **Dec 2025 — Disclaimer Placement Relief:** FDA will no longer require the disclaimer on every label panel where a claim is made, as long as it appears on the label and is clearly linked.

| ❌ Danger Zone | ✅ Safe Language |
|---|---|
| "Clinically proven" | "Supported by research" |
| "Improves memory" | "Supports normal cognitive function" |
| "Treats fatigue" | "Supports energy metabolism" |
| "Reduces anxiety" | "Supports a calm mood" |
| "Freshest = more potent" | "Made to order for optimal freshness" |

- **⚠️ Flag for Ross:** The "freshness = higher efficacy" angle borders on an implied efficacy/superiority claim. Stick to *process* messaging ("made to order") rather than *outcome* messaging ("works better because it's fresh").
- **⚠️ Flag — EFSA Cognition Warning:** Health claims linking creatine and cognitive function improvement are not scientifically supported per EU EFSA at continuous low doses. In the U.S., "supports brain energy metabolism" is safer than "improves cognitive performance."

**Formula Recommendation:** File structure/function claims with FDA within 30 days of launch. Pre-cleared claims: (1) **"Supports cellular energy production"** (creatine/ATP, well-substantiated), (2) **"Supports muscle relaxation and restful sleep"** (magnesium, well-substantiated). Never use "clinically proven," "more effective," or "stronger formula."

---

## Saturday, 2026-03-28

### Sourcing — Amazon Landscape

**Most Important Finding:** There is a critical quality gap on Amazon: when SuppCo independently tested 44 best-selling supplements, half failed active-ingredient verification — and nine have since been removed. Only 8% of creatine products on Amazon are third-party certified. A transparently certified creatine + magnesium glycinate capsule from a DTC brand would stand out sharply.

- **Price Range & Ratings:** Magnesium glycinate ASINs concentrated in $20–$50 (52.71% of listings); 81.27% of ASINs rated 4.3–4.7. Creatine capsule-only products: ~$15–$30. Premium combo bundles (Thorne): $50–$70+. A branded combo at ~$35–$45 DTC is well-positioned in the gap.
- **Pill burden = top complaint:** Up to 6 pills to reach recommended daily dose. Capsule size likened to fish oil capsules. Pill count is a real friction point.
- **Bloating & GI = #1 negative review theme:** Cause is often low-quality, poorly purified creatine. Micronized, lab-tested creatine greatly limits side effects. Pairing with magnesium glycinate (gut-gentle) directly addresses this.
- **Magnesium glycinate is having a cultural moment:** 1,158% adoption rate YTD on SuppCo, 189,506 users added it since January.
- **Amazon combo landscape is fragmented:** Closest competition is Thorne's bundle (Mag CitraMate + Creatine powder), BioEmblem's powder bundle, and a few gummy combos. No clear winner in creatine monohydrate + magnesium glycinate **capsule** format targeting women.

**Recommended Action:** Purchase and do a teardown of the **Thorne Mag + Creatine bundle** and the **BioEmblem Creatine + Mag Glycinate bundle**. Read every 1- and 2-star review carefully. Use the exact complaints as your product differentiation blueprint.

> **Ross's note (Mar 28):** "6 pills is too many. We need to figure this out. Either gummies or powder need to be reexamined."

---

### Science — Women's Health & Creatine

**Lead Finding:** The evidence is real, but skewed toward post-menopause — new 2025 RCT fills a critical gap for perimenopause specifically.

- **Cognition & Brain Fog:** 2025 RCT (CONCRET-MENOPA): 1,500 mg/day creatine HCl improved reaction time (1.2 vs. 6.6%; p<0.01) and raised frontal brain creatine levels in perimenopausal and menopausal women. 2024 meta-analysis (16 RCTs): significant positive effects on memory, attention, processing speed — **more beneficial in females.**
- **Mood & Depression:** Dietary creatine intake is inversely proportional to depression occurrence (31% greater incidence in lowest quartile). Depression rates 2x higher in females. CONCRET-MENOPA trial showed potential advantage in **reducing severity of mood swings** (p=0.06).
- **⚠️ Bone Density FLAG:** A 2-year double-blind RCT with 200 postmenopausal women at 3g/day found creatine supplementation **did not improve bone health** without exercise. Do NOT make bone density claims without tying them to an exercise program.
- **Sleep:** A 2025 quasi-experimental study found perimenopausal women showed positive improvements in sleep quality (p=0.0181).
- **Research Gap:** As of May 2025, there had been no studies examining creatine in perimenopausal women specifically. CONCRET-MENOPA (August 2025) is the first. You are launching with fresh, validating science.
...
## SOURCING BRIEFING — Manufacturer Intel — April 6, 2026

**🔑 TOP FINDING: Makers Nutrition is the clear frontrunner for Ross's use case. It holds the strongest recent reputation, confirmed powder capabilities, the lowest publicly referenced MOQ (500 units for private label), and a 4-week turnaround that aligns perfectly with a batch-drop model. Vitalpax is a compelling backup with ~8-week lead times. NutraScience has a meaningful red flag: not BBB accredited and on record for failing to respond to at least one complaint.**

---

### MAKERS NUTRITION (Commack, NY)
- In 2026, Makers Nutrition continues to excel due to their accessibility. While many large manufacturers have raised their MOQs to prohibitive levels, Makers Nutrition remains supportive of growing brands while possessing the capacity to serve enterprise clients.
- Their private label products are offered at a low MOQ of **500 units** — a strong fit for a 150 pre-order batch-drop trigger. Custom formulations will be higher, but worth asking.
- Fast turnaround times — **4–6 weeks** for many standard products.
- At least one client confirmed Makers Nutrition "lived up to the promise of a 4-week turnaround time."
- Powder manufacturing is flagged as a growing category — "consumers are reaching for powders more than ever" and Makers Nutrition is seeing a spike in requests for custom powders supporting immune health, metabolism, and mental clarity.
- ✅ FDA-registered, NSF GMP certified. BBB Accredited since 2023. No significant public complaints found.

---

### NUTRASCIENCE LABS (Farmingdale, NY)
- Headquartered in Farmingdale, NY, their expertise lies in contract manufacturing customized capsule, tablet, powder, and soft gel products. They claim rapid lead times and price quotes delivered within an average of 48 business hours.
- NutraScience Labs has renewed its cGMP certification via NSF International for its facilities in Farmingdale and Hauppauge, NY (renewed as recently as September 2025).
- ⚠️ **Red flag:** NutraScience Labs is **NOT BBB Accredited** and has a record of **failure to respond to at least one complaint** filed against the business.
- ⚠️ Historical legal note: NutraScience Labs was named in a California Prop 65 action related to lead exposure levels in covered products (2020 case). Old, but worth knowing for a wellness-positioned brand.
- On the positive side, at least one founder reported NutraScience Labs replied to manufacturing inquiries "literally within 24 hours."

---

### VITALPAX (LaVerkin, UT)
- Established in 2014, Vitalpax is a family-owned business in southern Utah, providing customers with premium quality nutritional products backed by science.
- Vitalpax holds cGMP, NSF, and USDA Organic certifications, with turnkey services covering R&D to production to marketing across capsule, liquid, softgel, tablet, and other formats.
- The CEO touts "unbeatable pricing" and a turnaround of about **half the industry average** — "a lot of manufacturers give 4-month lead times; we're more like **8 weeks**." They also handle small-batch manufacturing.
- MOQs are not published and "vary by dosage form, packaging, and ingredient constraints" — they discuss practical starting volumes during scoping. (You'll need to call to get a number.)
- Pilot or small-batch runs are explicitly available to de-risk scale-up and generate market test inventory.

---

**RECOMMENDED ACTION:**
Call Makers Nutrition this week (1-844-625-3771) and request a quote specifically for a **custom powder blend** (creatine monohydrate + magnesium glycinate) at **500–1,000 units**. Confirm whether their 4–6 week lead time applies to powders, not just capsules. Simultaneously, email Vitalpax to get a competing MOQ/price quote for the same formula — their small-batch openness and 8-week lead time make them a strong Plan B.

### Science

# SCIENCE BRIEFING — Stability Science — April 6, 2026

---

## 🔬 LEAD FINDING: Creatine monohydrate is exceptionally stable in dry powder form — but degrades rapidly in solution. The "freshness" angle has nuance.

---

### POWDER STABILITY: Remarkably Strong

The peer-reviewed science here is clear and well-established. At room temperature and even at an increased temperature of 40°C (104°F), creatine monohydrate shows no signs of degradation — creatinine levels stay under the quantification limit of 67 ppm — after more than 3 years. Even under extreme conditions, when stored at 60°C (140°F), creatinine (106 ppm) was only detected after a period of 44 months (Jäger 2003).

This is confirmed by a 2025 multi-analytical study in *Food Research International* that used ATR-FTIR and HRMS techniques, revealing that temperature was the most significant factor affecting creatine stability and that HRMS analysis identified several degradation products. Notably, creatine is generally considered stable in powder form but demonstrates significant instability in aqueous solutions, with degradation accelerated by lower pH and higher temperatures.

---

### THE CREATININE PROBLEM: It's About Solution, Not Powder Age

The degradation pathway that actually matters for consumers isn't shelf time — it's **what they mix it with**. Harris et al. reported that creatine is relatively stable for 3 days in solution at neutral pH (6.5–7.5), but the rate of degradation to creatinine increased when stored at 25°C as pH decreased (e.g., 4% at pH 5.5; 12% at pH 4.5; and 21% at pH 3.5).

In practical terms: pre-mixed creatine solutions at pH around 3 to 4 may show measurable conversion to creatinine within 24 to 48 hours at room temperature. This strongly argues for the powder-format, mix-on-demand approach.

---

### ⚠️ FLAG: Where "Freshness" Doesn't Hold Up

The freshness angle cannot credibly claim **potency preservation** in dry powder format — science shows a 2-year-old sealed bag is virtually identical to a new one. While many manufacturers list an expiration date of two years after production, stability data supports a longer shelf life for creatine monohydrate supplements.

**However**, "freshness" CAN be defensibly repositioned around: (1) **moisture integrity** — freshly manufactured product has had zero humidity exposure, and any exposure to humidity, condensation, or direct water contact will kickstart the degradation process into creatinine; and (2) **solution freshness** — the instruction to mix immediately before drinking is scientifically valid and differentiating.

---

### BONUS: New Science Supporting the Product Concept

A 2025 narrative review in *JISSN* confirms that creatine monohydrate is safe and has beneficial effects on measures of whole-body lean body mass, muscle strength, bone area and thickness, cognition and memory — directly relevant to the target demographic.
