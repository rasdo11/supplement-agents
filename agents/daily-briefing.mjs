...
CONTEXT:
- Formula: Creatine monohydrate (1.5-3g) + magnesium glycinate (200-400mg) in capsule
- Target: Women 30-45, wellness/longevity, not bodybuilding
- Brand angle: "Freshest batch" — manufactured to order
- Need daily capsule count under 4-6
...
async function main() {
  ...
  const emailBody = [
    ...
    '',
    '━'.repeat(40),
    'Generated by your sourcing and science agents.',
    'Reply to discuss in your next Claude session.',
    '━'.repeat(40),
  ].join('\n');
